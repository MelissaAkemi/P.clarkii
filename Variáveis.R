...
#Dataframe com occs
occs <- read.csv(file = "gbif_,Procambarus clarkii,.csv", header = T);
head(occs)
...
####BIO01
bio1<-raster("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/wc2.1_5m_bioc_BCC-CSM2-MR_ssp126_2021-2040.tif.opdownload")
bio1
plot(bio1)
